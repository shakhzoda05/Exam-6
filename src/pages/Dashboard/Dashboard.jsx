    ...
    <div className="h-screen overflow-y-auto ">
      <header className="flex items-center mb-[53px] px-[124px] py-[15px] bg-gray-5 justify-between">
        ...
        <div className="flex items-center gap-12">
          ...
          <Button  onclick={() => setShowIsLogOutModal(true)} title={"Log out"} extraStyle={`px-[35px] cursor-pointer bg-blu-200 hover:bg-red-500 hover:shadow-md transition duration-200 ease-in-outrounded-md `}
/>
        </div>
      </header>
