            ...
            <label className="flex flex-col gap-4">
              ...
              <div className="relative overflow-hidden w-fit group">
                <img
                  ...
                  alt="Teacher"
                />
                <div className="absolute left-0 flex items-center justify-center w-full h- text-white group-hover:top-0 -top-full duration-300 backdrop-blur-sm bg-black/30">
                  <FaXmark
